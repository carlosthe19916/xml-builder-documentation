...
## Ejemplo
El siguiente ejemplo crea una factura INAFECTA. Deberás de utilizar el endpoint para crear facturas; si deseas crear notas de crédito, o notas de débito entonces deberás de utilizar un endpoint diferente.
